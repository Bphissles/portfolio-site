...
<template>
  <main>
    <div class="wrapper">
      <Heading projectName="" heading="Let's see what I can do next." subHeading="Let's work together"/>
...
export default {
  name: "contact-page",
  components: { Heading, HeadingWithCopy, ContactForm, ContactContainer },
  data() {
      return {
        extraCardTemp:3
      }
